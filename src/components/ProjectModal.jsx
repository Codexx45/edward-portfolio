  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex justify-center items-center">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-950 to-black rounded-3xl p-6 w-full max-w-8xl sm:max-w-7xl shadow-2xl border-2 border-cyan-700/30 flex flex-col items-center">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-l text-cyan-400 hover:text-red-500 transition-colors bg-white/10 rounded-full p-2 shadow-lg"
          aria-label="Close"
        >
        ...
        <div className="flex items-center justify-center w-full mt-4 gap-4">
          <button
            onClick={prevSlide}
            className="text-l text-cyan-400 hover:text-white bg-cyan-700/30 rounded-full p-3 transition-colors shadow-md"
